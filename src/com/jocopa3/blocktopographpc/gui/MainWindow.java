    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                list.add(ImageUtil.readImage("icon512.png"));
                list.add(ImageUtil.readImage("icon256.png"));
                list.add(ImageUtil.readImage("icon128.png"));
                list.add(ImageUtil.readImage("icon64.png"));
                list.add(ImageUtil.readImage("icon32.png"));
                mw.setIconImages(list);
