...
public enum NBTSignature {
    ...
    LIST_POS_TAG(0xDFF9F43C33C551DDL, "X:%f | Y:%f | Z:%f"), // Position x, y, z tag
            ...
            switch(signature) {
                    ...
                    if(tag instanceof CompoundTag) {
                        ...
                        for(Tag child : ((CompoundTag)tag).getValue()) {
                            switch(child.getName()) {
                                case "Count": count = (byte)child.getValue(); break;
                                case "Damage": damage = (short)child.getValue(); break;
                                case "id": id = (short)child.getValue(); break;
                            }
                        }
                ...
                case COMPOUND_ATTRIBUTE_ITEM:
                    if(tag instanceof CompoundTag) {
                        ...
                        for(Tag child : ((CompoundTag)tag).getValue()) {
                            switch(child.getName()) {
                                case "Base": base = (float)child.getValue(); break;
                                case "Max": max = (float)child.getValue(); break;
                                case "Current": current = (float)child.getValue(); break;
                                case "Name": Name = (String)child.getValue(); break;
                            }
                        }
                    ...
                    if(tag instanceof CompoundTag) {
                        ...
                        for(Tag child : ((CompoundTag)tag).getValue()) {
                            switch(child.getName()) {
                                case "Count": count = (byte)child.getValue(); break;
                                case "Damage": damage = (short)child.getValue(); break;
                                case "Slot": slot = (byte)child.getValue(); break;
                                case "id": id = (short)child.getValue(); break;
                            }
                        }
